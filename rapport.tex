...
& \omega_2&=&\sqrt{2+\sqrt{2}} \omega_o
& \omega_3&=&\sqrt{2-\sqrt{2}} \omega_o
\end{IEEEeqnarray*}
...
Q(t)&=&\frac{c_1}{\sqrt{2}}\begin{bmatris}1 \\ 0 \\ -1\end{bmatrix} \sin{\sqrt{2} \omega_ot+\Fi_1} 
&+\frac{c_2}{2}\begin{bmatris}1 \\ -\sqrt{2} \\ 1\end{bmatrix} \sin{\sqrt{2+\sqrt{2}} \omega_ot+\Fi_2} 
&+\frac{c_2}{2}\begin{bmatris}1 \\ \sqrt{2} \\ 1\end{bmatrix} \sin{\sqrt{2-\sqrt{2}} \omega_ot+\Fi_3} 
\end{IEEEeqnarray*}
Vilket på matrisform kan skrivas som:
\begin{IEEEeqnaray*}{rCl}
\hat{A}&=&
\begin{bmatrix}
...
Q(t)=\hat{A}
\begin{bmatrix}
c_1 \sin{\sqrt{2} \omega_o t+ \Fi_1} \\
c_2 \sin{\sqrt{2+\sqrt{2}} \omega_o t+ \Fi_2} \\
c_3 \sin{\sqrt{2-\sqrt{2}} \omega_o t+ \Fi_3}
\end{bmatrix}
\end{IEEEeqnarray*}
