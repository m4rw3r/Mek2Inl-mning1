...
\section{Problem 1}
	...
	Genom att betrakta $(K-\frac{\omega_i^2}{\omega_o^2})A_i=0$ för $i=1,2,3$ finner vi egenvektorerna:
...
\end{cases}
\end{IEEEeqnarray*}
Vilket ger kvoten för egensväningarna: $\frac{\omega_3}{\omega_2} =\sqrt{\frac{11}{6}}=1.3540$. Kvoten för de givna energinivåerna: $\frac{E_2}{E_1} = \frac{2349}{1388} = 1.6924$. För att ta ställning till hur bra approximationen är betraktar vi det relativa felet $\abs{\frac{E_2}{E_1}-\frac{\omega_3}{\omega_2}}/\abs{\frac{E_2}{E_1}} = 0.19993$, vilket motsvarar en relativt väll approximation i någon menning.
\end{document}
